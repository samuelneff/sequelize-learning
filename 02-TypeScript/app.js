...
var sequelize = new Sequelize("sequelize-learning-01", "dev", password, {
    dialect: "mysql",
    port: 3306
});
...
function createTasks() {
    ...
    for (var ui = 0; ui < 5; ui++) {
        ...
        for (var ti = 0; ti < 10; ti++) {
            Task.create({ userId: user.userId, taskName: "Task " + ti + " for user " + user.userName }).complete(function (err, task) {
                if (err) {
